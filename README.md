# magic-ml4co
#record the paper about machine learning for combinatorial optimization resources
...
2. **Smart "Predict, then Optimize"** Management Science, 2017. [paper](https://arxiv.org/abs/1710.08005)
    *Adam N. Elmachtoub, Paul Grigas*
3. **Decision-Focused Learning: Foundations, State of the Art, Benchmark and Future Opportunities** JAIR, 2023. [paper](https://arxiv.org/abs/1710.08005), [code](https://github.com/PredOpt/predopt-benchmarks)
    *Jayanta Mandi, James Kotary, Senne Berden, Maxime Mulamba, Victor Bucarey, Tias Guns, Ferdinando Fioretto*
4. **DFF: Decision-Focused Fine-tuning for Smarter Predict-then-Optimize with Limited Data** AAAI, 2025. [paper](https://arxiv.org/abs/2501.01874), [code](https://github.com/cvxgrp/cvxpylayers)
    *Jiaqi Yang, Enming Liang, Zicheng Su, Zhichao Zou, Peng Zhen, Jiecheng Guo, Wanjing Ma, Kun*
